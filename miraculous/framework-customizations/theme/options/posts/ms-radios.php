<?php if( !defined('FW') ) die('Forbidden');$options = array(
    'radio_options' => array(
        'type' => 'box',
        'title' => __('Radio Options', 'miraculous'),
        'options' => array(
            'radio_songs' => array(
                'type'  => 'select-multiple',
                'label' => __('Song Name', 'miraculous'),
                'desc'  => __('Select Songs you wish to assign for this radio.', 'miraculous'),
                'choices' => miraculous_get_all_songs_name_for_album_post(),
            ),
            'radio_artists' => array(
                'type'  => 'select-multiple',
                'label' => __('Artist Name', 'miraculous'),
                'desc'  => __('Select Artists you wish to assign for this radio.', 'miraculous'),
                'choices' => miraculous_get_all_artists_name_for_album_post(),
            ),
            'radio_company_name' => array(
                'type' => 'text',
